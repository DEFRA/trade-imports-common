...
namespace Defra.TradeImports.EmfExporter;

public static class EmfExportExtensions
{
    public static IApplicationBuilder UseEmfExporter(this IApplicationBuilder builder, string meterName)
    {
        ...
        if (enabled)
        {
            ...
            EmfExporter.Init(builder.ApplicationServices.GetRequiredService<ILoggerFactory>(), meterName, ns);
        }
